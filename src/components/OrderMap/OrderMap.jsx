...
const OrderMap = ({ restaurant, isHistoryView }) => {
  ...
  const originalPriceNum = Number(restaurant.originalPrice) || 0;
  const totalPriceNum = Number(restaurant.totalPrice) || 0;
  const discountAmount = originalPriceNum - totalPriceNum;
            ...
            <p className={styles.pickupTime}>
              <span className={styles.clockIcon}>
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14 8.16667V14H19.8333M14 24.5C8.20101 24.5 3.5 19.799 3.5 14C3.5 8.20101 8.20101 3.5 14 3.5C19.799 3.5 24.5 8.20101 24.5 14C24.5 19.799 19.799 24.5 14 24.5Z" stroke="#2E2E2E" strokeWidth="2.44444" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </span> 
              Можно забрать до 23:00
            </p>
          </div>
        ) : (
          <div className={styles.orderSummary}>
            ...
            <div className={styles.priceDetails}>
              <div className={styles.priceRow}>
                ...
                <span>{originalPriceNum.toLocaleString()} ₽</span>
              </div>
              <div className={styles.priceRow}>
                <span>Скидка</span>
            ...
            <div className={styles.totalRow}>
              <span>Итого</span>
              <span className={styles.totalPrice}>{totalPriceNum.toLocaleString()} ₽</span>
            </div>
